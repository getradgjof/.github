...
- The Priority dropdown in the form is for triage; it does not auto-apply a label. Apply the corresponding `P#` label during triage or automate with additional workflows if desired.
